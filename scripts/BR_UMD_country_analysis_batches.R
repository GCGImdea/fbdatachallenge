...
if (use_unsmoothed_UMD) {
  ...
  ## Smoothed Data
  data_s <- read.csv("../data/UMD/Full Survey Data/region/smoothed/bra_region_full_smoothed.csv",
                     fileEncoding = "UTF-8")
...
p2
ggsave(plot = p2, 
       filename =  "../data/estimates-umd-batches/BR/plots_by_batch_size/BR-country_cli_vs_anosmia_by_batch_size.png", 
       width = 9, height = 6)
...
p3
ggsave(plot = p3, 
       filename =  "../data/estimates-umd-batches/BR/plots_by_batch_size/BR-country_fever_vs_anosmia_by_batch_size.png", 
       width = 9, height = 6)
...
p4
ggsave(plot = p4, 
       filename =  "../data/estimates-umd-batches/BR/plots_by_batch_size/BR-country_ili_vs_anosmia_by_batch_size.png", 
       width = 9, height = 6)
...
#   theme_bw()
# p2
# anim_save("../data/estimates-umd-batches/BR/plots_by_batch_size/batch_size_effect_BR_country.gif")
